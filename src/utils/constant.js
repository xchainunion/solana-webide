...
export const MULTI_ASSET_CALL = 2;
...
export const mainNetRPCHttpsAddr = 'https://api.mainnet-beta.solana.com'; 
export const testNetRPCHttpsAddr = 'https://api.testnet.solana.com';
